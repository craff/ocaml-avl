...
module type S =
  sig
    ...
    (** Return the smallest element of the given set and the set with
        this element removed, or raise [Not_found] if the set is empty.*)
    ...
    (** Return the largest element of the given set and the set with
        this element removed, or raise [Not_found] if the set is empty.*)
